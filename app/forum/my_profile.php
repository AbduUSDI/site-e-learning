    ...
    <div class="card">
        <div class="card-body">
            <?php if (!empty($userProfile['photo_profil'])): ?>
                <img src="../uploads/profile_pictures/<?php echo htmlspecialchars($userProfile['photo_profil']); ?>" alt="Photo de profil" class="img-thumbnail mb-3" style="max-width: 200px;">
            <?php endif; ?>
